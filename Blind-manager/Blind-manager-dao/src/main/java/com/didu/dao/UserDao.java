...
public interface UserDao {
    ...
    @Insert("insert into reduser(redname,phone,identity,city,wechat,remark,status,address,introduce,workname,birthdata) values(#{redname},#{phone},#{identity},#{city},#{wechat},#{remark},#{status},#{address},#{introduce},#{workname},#{birthdata})")
